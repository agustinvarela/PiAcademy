...
module.exports = {
    ...
    arbol: (req, res) => {
        res.render('./posts/arbol-reproduccion')
    },
    ConfiguracionPCobrar: (req, res) => {
        res.render('./posts/cobrar-configuraciones')
    },
    becas: (req, res) => {
        res.render('./posts/crear-becas')
    },
    cuentaEconomica: (req, res) => {
        res.render('./posts/cuenta-economica')
    },
    becados: (req, res) => {
        res.render('./posts/ganancia-becados')
    },
    reproduccion: (req, res) => {
        res.render('./posts/reproducciones')
    },
    ganarSlpExp: (req, res) => {
        res.render('./posts/slp-exp')
    },
    ComoEsUnTerminator: (req, res) => {
        res.render('./posts/terminator')
    },
